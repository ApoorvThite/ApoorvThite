...
|------------|---------|---------|---------|
| S1E1 | [**NVDA Stock Forecasting (LSTM)**](https://github.com/ApoorvThite/Stock_Prediction) | Deep learning meets market timing | ![](https://github.com/ApoorvThite/ApoorvThite/blob/main/stock_forecasting.png) |
